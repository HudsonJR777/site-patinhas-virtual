    ...
    <div className="border-2 border-white flex flex-col m-6 space-y-8 bg-[#4a128c] shadow-2xl text-black text-lg rounded-2xl lg:flex lg:flex-1 lg:items-center lg:justify-center w-full lg:max-w-[680px] lg:w-1/2">
      <div className="w-full">
        <div className="bg-[#ffb302] flex items-center justify-between w-full py-5 rounded-t-xl border-b-4 border-black px-4">
          <span className="mb-3 text-4xl text-center font-bold  mx-auto text-primaryColor">
            Cadastra afiliado
          </span>
          ...
          <div className="flex flex-col lg:flex lg:flex-col items-center justify-center gap-3 py-4 w-full">
            <div className="flex items-center justify-center lg:justify-start">
              ...
              <p className="text-sm lg:text-lg text-white font-semibold">
                Eu aceito todos{" "}
                <span className="text-sm lg:text-lg text-[#ffb302] font-bold">
                  termos e condições
                </span>
              </p>
            </div>
            <button className="w-[150px] items-center rounded-full bg-[#ffb302] text-white p-2 text-lg font-semibold hover:bg-white hover:text-[#4a128c] border hover:border-[#4a128c]">
              Entrar
            </button>
          </div>
        </div>
